...
export function ChatPane({
  ...
  // fork(local-only): never offer the switch-to-cloud CTA — Retry keeps the
  // primary slot and contact-support rises per the ladder below. The explicit
  // `boolean` annotation keeps TS control-flow from narrowing this to the
  // literal false.
  const showCloudSwitchCta: boolean =
    false && Boolean(cloudSwitchTracking) && !cloudSwitchCtaCannotTakeTheHandoff;
  /**
   * 一张卡只有一颗主按钮。
   *
